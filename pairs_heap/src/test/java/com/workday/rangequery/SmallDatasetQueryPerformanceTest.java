...
public class SmallDatasetQueryPerformanceTest {
	...
	public void checkARangeQueryTime() {
        ...
        System.out.println("Minheap Pairs: Small Dataset Query 1: " + (stopTime - startTime));

		startTime = System.nanoTime();
		ids = rc.findIdsInRange(14, 17, true, false);
		stopTime = System.nanoTime();
        System.out.println("Minheap Pairs: Small Dataset Query 2: " + (stopTime - startTime));

		startTime = System.nanoTime();
		ids = rc.findIdsInRange(20, Long.MAX_VALUE, false, true);
		stopTime = System.nanoTime();
        System.out.println("Minheap Pairs: Small Dataset Query 3: " + (stopTime - startTime));
	}
	...
	public void checkARangeQueryMemory() {
        ...
        System.out.println("Minheap Pairs: Small Dataset Query memory in bytes : " + memory);
	}

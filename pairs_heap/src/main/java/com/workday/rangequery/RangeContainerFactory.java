...
interface RangeContainerFactory {
	...
	* The position in the â€œdataâ€? array represents the â€œidâ€? for that instance
	* in question. For the â€œPayrollResultâ€? example before, the â€œidâ€? might be
	* the workerâ€™s employee number, the data value is the corresponding

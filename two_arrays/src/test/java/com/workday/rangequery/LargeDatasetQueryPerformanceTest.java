...
public class LargeDatasetQueryPerformanceTest {
	...
	public void checkARangeQueryTime() {
		...
		System.out.println("Two Arrays: Large Dataset Query 1: " + (stopTime - startTime));

		startTime = System.nanoTime();
		ids = rc.findIdsInRange(14, 517, true, false);
		stopTime = System.nanoTime();
		System.out.println("Two Arrays: Large Dataset Query 2: " + (stopTime - startTime));

		startTime = System.nanoTime();
		ids = rc.findIdsInRange(Long.MAX_VALUE-100, Long.MAX_VALUE, false, true);
		stopTime = System.nanoTime();
		System.out.println("Two Arrays: Large Dataset Query 3: " + (stopTime - startTime));
	}
	...
	public void checkARangeQueryMemory() {
		...
		System.out.println("Two Arrays: Large Dataset Query memory in bytes : " + memory);
	}
